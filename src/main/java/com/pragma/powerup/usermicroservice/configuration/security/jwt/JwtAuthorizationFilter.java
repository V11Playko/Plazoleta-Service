...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        rolesEndpointsMap.put("ROLE_EMPLOYEE", Arrays.asList("/food-court/v1/employee/orders", "/food-court/v1/employee/assign-orders", "/food-court/v1/employee/order-ready"));
