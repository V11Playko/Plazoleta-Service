...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        rolesEndpointsMap.put("ROLE_CLIENT", Arrays.asList("/food-court/v1/client/list-restaurants", "/food-court/v1/client/list-dishes-restaurant", "/food-court/v1/client/new-order", "/food-court/v1/client/order-cancel", "/food-court/v1/client/order/{id}"));
